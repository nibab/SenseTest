	...
	return (
		<div>
			...
			<div className={`mt-1 relative rounded-md shadow-sm`}>
				<input onChange={() => onInputChange()} id={props.type} ref={ref} type={props.type} placeholder={props.placeholder} required className={`appearance-none block w-full px-3 py-2 border ${validationError ? 'border-red-300' : 'border-gray-300 '} rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5`} />
