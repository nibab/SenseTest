...
const VersionTag = (props: VersionTagProps) => {
    return(
        <span className="font-mono ml-2 inline-flex flex-shrink-0 items-center px-2.5 py-0.5 rounded-md text-xs font-bold leading-5 bg-indigo-100 text-indigo-800">
