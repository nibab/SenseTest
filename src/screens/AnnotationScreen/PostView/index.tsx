			...
			<div className='flex-shrink-0 mr-3'>
				<div className='rounded-full flex-shrink-0'>
					<div id='button-container' className='w-full flex-col'> 
						...
						<div className='w-full h-16 my-1 flex flex-col'>
							<button onClick={() => {setDisplaySimulator(!displaySimulator)}} className="focus:outline-none  border-gray-400 shadow-lg active:shadow-sm active:bg-gray-300 w-10 h-10 bg-white rounded-full mx-auto" style={{borderWidth: '1px'}}>
            ...
            <div className='flex-auto relative overflow-hidden'>
				...
				<div className='overflow-scroll flex-auto h-full flex flex-col relative'> 
					...
					<div className='my-auto h-full flex flex-row pl-2 pr-2'> 
						{ renderToolBar() }
						{ displaySimulator ? renderSimulator() : <></> }
						{ renderScreenshot() }
