			...
			{/* { renderWarningMessage() } */}
           	<div className='relative flex flex-col flex-auto h-full'> 
				...
				<div className='flex flex-row pt-2 pb-1 pl-2 pr-2 overflow-scroll'> 				
					{ renderToolbar() }	
					{ displayState === 'Simulator'  && simulatorParams?.appBuild !== undefined ? <div className="ml-3"><Simulator deviceType={'IPHONE_X'} mode={'VIEW'} appBuild={simulatorParams?.appBuild}/></div> : <></> }
