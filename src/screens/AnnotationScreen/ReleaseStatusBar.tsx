...
export const ReleaseStatusBar = () => {
	return (
		<div className='flex-auto relative '>
			<div className="z-30 w-full absolute px-2 pt-2 sticky">
				<div className=' w-full bg-gray-300 shadow-md rounded-full flex flex-col'> 
					<div className="mx-auto w-full flex justify-center h-10 relative">
						...
						<div className=" flex my-auto uppercase font-semibold text-xs text-gray-700 flex flex-row">
							Release progress
							<div className='ml-4 w-96 h-2 my-auto'>
								<div className='h-2 w-full  bg-green-600 rounded-full'></div>
							</div>
